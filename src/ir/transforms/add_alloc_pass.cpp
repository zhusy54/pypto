 ...
 */
std::vector<std::pair<const MemRef*, MemRefPtr>> AllocateMemoryAddresses(const std::vector<MemRefPtr>& memrefs) {
 ...
 */
std::vector<StmtPtr> CreateAllocStatements(const std::vector<std::pair<const MemRef*, MemRefPtr>>& memref_pairs) {
